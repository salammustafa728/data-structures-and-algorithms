...
Write a function named getCourseKeys that takes in the courseInfo object and returns an array containing the keys for the
 courseInfo object.
...
const getHouses = (arr) => {
  let houses = [];
  // Solution code here...
  arr.map(val=>houses.push(val.house));
  return houses;
};
...
Write a function named hasChildrenValues that uses Object.values to determine if any given character in the data set has
children.
