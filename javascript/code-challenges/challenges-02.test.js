...
let raisedToTheThird = (arr) => {
  // Solution code here...
  const powArr=[];
  arr.forEach((value)=> powArr.push(Math.pow(value,3)));
  return powArr;
};
...
let addOne = (arr) => {
  // Solution code here...
  const addOneArr= arr.map((value)=> value+1);
  return addOneArr;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i=0;i<arr.length;i++){
    arrRaise.push(Math.pow(2,arr[i]));
  }
  return arrRaise;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let arrRaise=[];
  arr.forEach((value)=>{ arrRaise.push(Math.pow(2,value));});
  return arrRaise;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let arrRaise=[];
  arr.map((value)=>{ arrRaise.push(Math.pow(2,value));});
  return arrRaise;
};
